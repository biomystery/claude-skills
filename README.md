...
| [grill-science-with-docs](grill-science-with-docs/) | `/grill-science-with-docs` | Two-phase interrogation for analysing a dataset you did not create — Phase 1 grills the source paper's methods, enumerates every sheet/table so absence is never assumed, pins the unit of analysis and denominators, and blocks work at a hard alignment gate; Phase 2 runs a pre-specified analysis with rendered-and-inspected figures, a correction log, and an explicit statement of what the data cannot settle |
