...
| [hub-from-outline](hub-from-outline/) | `/hub-from-outline` | Ingest a course/book/syllabus outline into an Obsidian hub → modules → optional weeks fill-in structure, with an optional Mermaid outline-index graph |
